...
{
	printk(KERN_DEBUG "onedram_checksum---driver/misc/samsung_modemctl/modem_ctl.c");
	u32 temp = org;
	u32 i;
...
{
	printk(KERN_DEBUG "read_semaphore---driver/misc/samsung_modemctl/modem_ctl.c");
	return ioread32(mc->mmio + OFF_SEM) & 1;
}

static void return_semaphore(struct modemctl *mc)
{
	printk(KERN_DEBUG "return_semaphore---driver/misc/samsung_modemctl/modem_ctl.c");
	iowrite32(0, mc->mmio + OFF_SEM);
}

static u32 get_mailbox_ab(struct modemctl *mc)
{
	printk(KERN_DEBUG "get_mailbox_ab---driver/misc/samsung_modemctl/modem_ctl.c");
	return ioread32(mc->mmio + OFF_MBOX_BP);
}

static void set_mailbox_ba(struct modemctl *mc, u32 data)
{
	printk(KERN_DEBUG "set_mailbox_ba---driver/misc/samsung_modemctl/modem_ctl.c");
	iowrite32(data, mc->mmio + OFF_MBOX_AP);
}

static void write_single_data(struct modemctl *mc, int offset, int data)
{
	printk(KERN_DEBUG "write_single_data---driver/misc/samsung_modemctl/modem_ctl.c");
...
static int read_multiple_data(struct modemctl *mc, int offset, char *buf,
			    size_t size)
{
	printk(KERN_DEBUG "read_multiple_data---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "dpram_write_from_user---driver/misc/samsung_modemctl/modem_ctl.c");
	if (!read_semaphore(mc)) {
		pr_err("Semaphore is held by modem!");
		return -EINVAL;
	}
...
{
	printk(KERN_DEBUG "modem_pwr_status---driver/misc/samsung_modemctl/modem_ctl.c");
	pr_debug("%s\n", __func__);
...
{
	printk(KERN_DEBUG "dpram_modem_pwroff---driver/misc/samsung_modemctl/modem_ctl.c");
	pr_debug("%s\n", __func__);
...
{
	printk(KERN_DEBUG "dpram_modem_reset---driver/misc/samsung_modemctl/modem_ctl.c");
	pr_debug("%s\n", __func__);
...
{
	printk(KERN_DEBUG "dpram_modem_pwron---driver/misc/samsung_modemctl/modem_ctl.c");
	int err = -1;
	int msec;
...
{
	printk(KERN_DEBUG "acquire_semaphore---driver/misc/samsung_modemctl/modem_ctl.c");
	int retrycnt = 20;
...
{
	printk(KERN_DEBUG "dpram_write_delta---driver/misc/samsung_modemctl/modem_ctl.c");
	int ret = 0;
...
static int dpram_write_full(struct modemctl *mc,
					char __user *firmware, int size)
{
	printk(KERN_DEBUG "dpram_write_full---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "dpram_update_delta---driver/misc/samsung_modemctl/modem_ctl.c");
	int err = 0;
	int msec = 0;
	u32 val;
...
{
	printk(KERN_DEBUG "dpram_update_full---driver/misc/samsung_modemctl/modem_ctl.c");
	int err;
...
{
	printk(KERN_DEBUG "dpram_process_modem_update---driver/misc/samsung_modemctl/modem_ctl.c");
	int ret = 0;
...
{
	printk(KERN_DEBUG "dpram_chk_delta_update---driver/misc/samsung_modemctl/modem_ctl.c");
	u32 status;
	int percent = 0;
	int err = 0;
...
static int dpram_chk_full_update(struct modemctl *mc,
					int __user *pct, char __user *msg)
{
	printk(KERN_DEBUG "dpram_chk_full_update---driver/misc/samsung_modemctl/modem_ctl.c");
	int err;
	u32 status = 0;
	u32 phone_active = 0;
	bool is_reboot = 0;
...
{
	printk(KERN_DEBUG "modem_request_sem---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "mmio_sem---driver/misc/samsung_modemctl/modem_ctl.c");
	return readl(mc->mmio + OFF_SEM) & 1;
}

int modem_request_mmio(struct modemctl *mc)
{
	printk(KERN_DEBUG "modem_request_mmio---driver/misc/samsung_modemctl/modem_ctl.c");
	unsigned long flags;
	int ret;
...
{
	printk(KERN_DEBUG "modem_release_mmio---driver/misc/samsung_modemctl/modem_ctl.c");
	unsigned long flags;
	spin_lock_irqsave(&mc->lock, flags);
	mc->mmio_req_count--;
...
{
	printk(KERN_DEBUG "mmio_owner_p---driver/misc/samsung_modemctl/modem_ctl.c");
	unsigned long flags;
	int ret;
	spin_lock_irqsave(&mc->lock, flags);
...
{
	printk(KERN_DEBUG "modem_acquire_mmio---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_open---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_release---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_read---driver/misc/samsung_modemctl/modem_ctl.c");
	struct modemctl *mc = filp->private_data;
	loff_t pos;
	int ret;
...
static ssize_t modemctl_write(struct file *filp, const char __user *buf,
			      size_t count, loff_t *ppos)
{
	printk(KERN_DEBUG "modemctl_write---driver/misc/samsung_modemctl/modem_ctl.c");
	struct modemctl *mc = filp->private_data;
	u32 owner;
	char *data;
	loff_t pos = *ppos;
...
{
	printk(KERN_DEBUG "modem_start---driver/misc/samsung_modemctl/modem_ctl.c");
	int ret;
...
{
	printk(KERN_DEBUG "modem_reset---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modem_off---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_ioctl---driver/misc/samsung_modemctl/modem_ctl.c");
	struct modemctl *mc = filp->private_data;
...
{
	printk(KERN_DEBUG "modemctl_bp_irq_handler---driver/misc/samsung_modemctl/modem_ctl.c");
	int value = 0;
...
{
	printk(KERN_DEBUG "modemctl_handle_offline---driver/misc/samsung_modemctl/modem_ctl.c");
	switch (mc->status) {
...
{
	printk(KERN_DEBUG "modemctl_mbox_irq_handler---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modem_force_crash---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_probe---driver/misc/samsung_modemctl/modem_ctl.c");
	int r = -ENOMEM;
	struct modemctl *mc;
...
{
	printk(KERN_DEBUG "modemctl_suspend---driver/misc/samsung_modemctl/modem_ctl.c");
...
{
	printk(KERN_DEBUG "modemctl_resume---driver/misc/samsung_modemctl/modem_ctl.c");
	struct modemctl *mc = dev_get_drvdata(pdev);
	gpio_set_value(mc->gpio_pda_active, 1);
	return 0;
}
...
{
	printk(KERN_DEBUG "modemctl_init---driver/misc/samsung_modemctl/modem_ctl.c");
