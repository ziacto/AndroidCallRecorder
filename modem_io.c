...
{
	printk(KERN_DEBUG "x_copy_to_user---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "x_copy_from_user---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "_fifo_read---driver/misc/samsung_modemctl/modem_io.c");
	unsigned n;
...
static unsigned _fifo_write(struct m_fifo *q, void *src,
			    unsigned count, copyfunc copy)
{
	printk(KERN_DEBUG "_fifo_write---driver/misc/samsung_modemctl/modem_io.c");
	unsigned n;
	unsigned head = *q->head;
	unsigned tail = *q->tail;
	unsigned size = q->size;
...
{
	printk(KERN_DEBUG "fifo_purge---driver/misc/samsung_modemctl/modem_io.c");
	*q->head = 0;
	*q->tail = 0;
}
...
{
	printk(KERN_DEBUG "fifo_skip---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "fifo_dump---driver/misc/samsung_modemctl/modem_io.c");
	if (count > 64)
		count = 64;
...
{
	printk(KERN_DEBUG "modem_update_state---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "modem_update_pipe---driver/misc/samsung_modemctl/modem_io.c");
	unsigned long flags;
...
{
	printk(KERN_DEBUG "modem_pipe_send---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "modem_pipe_read---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "modem_pipe_recv---driver/misc/samsung_modemctl/modem_io.c");
	int ret;
...
{
	printk(KERN_DEBUG "handle_raw_rx---driver/misc/samsung_modemctl/modem_io.c");
	struct raw_hdr raw;
...
{
	printk(KERN_DEBUG "handle_raw_tx---driver/misc/samsung_modemctl/modem_io.c");
	struct raw_hdr raw;
...
{
	printk(KERN_DEBUG "modem_handle_io---driver/misc/samsung_modemctl/modem_io.c");
	struct sk_buff *skb;
	struct vnet *vn;
	int i;
	int  cnt = 0;
...
{
	printk(KERN_DEBUG "vnet_open---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "vnet_stop---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "vnet_xmit---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "vnet_setup---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "push_fmt_header---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "pull_fmt_header---driver/misc/samsung_modemctl/modem_io.c");
	struct fmt_hdr *fh = header;
...
{
	printk(KERN_DEBUG "push_rfs_header---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "pull_rfs_header---driver/misc/samsung_modemctl/modem_io.c");
	struct rfs_hdr *rh = header;
...
{
	printk(KERN_DEBUG "pipe_open---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "pipe_ioctl---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "pipe_poll---driver/misc/samsung_modemctl/modem_io.c");
	unsigned long flags;
	struct m_pipe *pipe = filp->private_data;
	int ret;
...
{
	printk(KERN_DEBUG "modem_pipe_register---driver/misc/samsung_modemctl/modem_io.c");
...
{
	printk(KERN_DEBUG "modem_io_init---driver/misc/samsung_modemctl/modem_io.c");
	struct vnet *vn;
	int r;
	int i;
	int ch_id;
